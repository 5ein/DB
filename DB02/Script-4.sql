...
-- 문제 풀기
  ...
  -- pk, fk 설정 확인 문제(관계성 설정)
   ...
   ALTER TABLE "HR"."BBS" ADD CONSTRAINT "FK_MEMBER" FOREIGN KEY ("WRITER") REFERENCES "HR"."MEMBER" ("ID") ENABLE;
   
   ALTER TABLE "HR"."REPLY" ADD CONSTRAINT "FK_BBS" FOREIGN KEY ("WRITER") REFERENCES "HR"."BBS" ("NO") ENABLE;
   
   ALTER TABLE "HR"."REPLY" ADD CONSTRAINT "FK_MEMBER1" FOREIGN KEY ("WRITER") REFERENCES "HR"."MEMBER" ("ID") ENABLE;
